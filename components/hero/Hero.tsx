  ...
  return (
    <section className="section-card relative mb-6 grid gap-8 overflow-hidden px-6 py-16 sm:px-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:px-14 lg:py-20">
      ...
      <div className="relative z-10 grid gap-6">
        ...
        <h1 className="text-zinc-900 dark:text-zinc-100 m-0 max-w-3xl font-sans text-5xl font-extrabold leading-[0.95] tracking-tight sm:text-6xl lg:text-7xl">
          Build travel experiences that feel cinematic.
        </h1>
        <p className="m-0 max-w-2xl text-base leading-7 text-zinc-500 dark:text-zinc-400 sm:text-lg">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="#experiences"
            className="bg-zinc-900 dark:black text-white dark:text-black px-6 py-3 text-sm font-semibold rounded-xl hover:scale-105 transition-transform"
          >
            Explore trips
          </a>
          <a
            href="#stories"
            className="bg-white dark:bg-[#010302] text-zinc-900 dark:text-zinc-100 border border-black/5 dark:border-white/10 px-6 py-3 text-sm font-semibold rounded-xl hover:scale-105 transition-transform"
          >
            View stories
          </a>
        </div>
      ...
      <div className="relative z-10 min-h-[320px] rounded-3xl border border-black/5 dark:border-white/10 p-6 bg-white dark:bg-[#010302]">
        <div className="absolute right-6 top-8 w-44 card-premium p-4 shadow-xl animate-float">
          ...
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">A ready-made itinerary layout for your next trip.</p>
        </div>
        <div className="absolute bottom-8 left-6 w-52 card-premium p-4 shadow-xl animate-float [animation-delay:1s]">
          ...
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Track spend without leaving the planner.</p>
        </div>
      </div>
    </section>
  )
