    ...
    <section className="section-card relative mb-6 grid gap-8 overflow-hidden px-6 py-16 sm:px-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:px-14 lg:py-20">
      ...
      <div className="relative z-10 grid gap-6">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="#experiences"
            className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-6 py-3 text-sm font-semibold rounded-xl hover:scale-105 transition-transform"
          >
            Explore trips
          </a>
          <a
            href="#stories"
            className="bg-white dark:bg-[#111111] text-zinc-900 dark:text-zinc-100 border border-black/5 dark:border-white/10 px-6 py-3 text-sm font-semibold rounded-xl hover:scale-105 transition-transform"
          >
            View stories
          </a>
        </div>
