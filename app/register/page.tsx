            ...
            <form className="space-y-6" onSubmit={handleRegister}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-xl px-4 py-3.5 focus:outline-none focus:border-accent-primary/50 focus:ring-1 focus:ring-accent-primary/30 placeholder-text-secondary/40 transition-all backdrop-blur-sm" id="firstName" placeholder="John" type="text" />
                </div>
                <div>
                  <label className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 block mb-2" htmlFor="lastName">Last Name</label>
                  <input className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-xl px-4 py-3.5 focus:outline-none focus:border-accent-primary/50 focus:ring-1 focus:ring-accent-primary/30 placeholder-text-secondary/40 transition-all backdrop-blur-sm" id="lastName" placeholder="Doe" type="text" />
                </div>
              </div>
              ...
              <div>
                ...
                <input className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-xl px-4 py-3.5 focus:outline-none focus:border-accent-primary/50 focus:ring-1 focus:ring-accent-primary/30 placeholder-text-secondary/40 transition-all backdrop-blur-sm" id="email" placeholder="john@example.com" type="email" />
              </div>
              ...
              <div>
                ...
                <input className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-xl px-4 py-3.5 focus:outline-none focus:border-accent-primary/50 focus:ring-1 focus:ring-accent-primary/30 placeholder-text-secondary/40 transition-all backdrop-blur-sm" id="password" placeholder="Create a strong password" type="password" />
              </div>
